...
use ethportal_api::{
    ...
    types::execution::header_with_proof::{
        BlockHeaderProof, HeaderWithProof, HistoricalRootsBlockProof, HistoricalSummariesBlockProof,
    },
    Header,
};
...
mod test {
    ...
    use trin_utils::submodules::{portal_spec_tests_file_path, read_portal_spec_tests_file};
    ...
    async fn header_validator_validate_post_merge_pre_capella_header() {
        ...
        let file = read_portal_spec_tests_file("tests/mainnet/history/headers_with_proof/block_proofs_bellatrix/beacon_block_proof-15539558-cdf9ed89b0c43cda17398dc4da9cfc505e5ccd19f7c39e3b43474180f1051e01.yaml").unwrap();
    ...
    async fn header_validator_validate_post_capella_header(#[case] block_number: u64) {
        ...
        // Read the historical roots block proof from a test file
        let file = read_portal_spec_tests_file(format!("tests/mainnet/history/headers_with_proof/block_proofs_capella/beacon_block_proof-{block_number}.yaml")).unwrap();
        let value: serde_yaml::Value = serde_yaml::from_str(&file).unwrap();
        let header_hash = value
            .get("execution_block_header")
            .unwrap()
        ...
        let historical_summaries_bytes = fs::read(
            portal_spec_tests_file_path("tests/mainnet/history/headers_with_proof/block_proofs_capella/historical_summaries_at_slot_8953856.ssz"))
    ...
    fn read_epoch_accumulator_122() -> EpochAccumulator {
        let epoch_acc_bytes = fs::read(portal_spec_tests_file_path(
    ...
    const HWP_TEST_VECTOR_15_537_392: &str = "";
    // Test vector for ssz encoded header with proof: BlockNumber 15537393
    const HWP_TEST_VECTOR_15_537_393: &str = "";
}
